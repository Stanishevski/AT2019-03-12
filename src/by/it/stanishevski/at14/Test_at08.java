 ...
 */
    ...
    private static Test_at08 run(String in) {
        return run(in, true);
    }

    private static Test_at08 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_at08(clName, in, runMain);
    }
    ...
    private Test_at08(String className, String in, boolean runMain) {
